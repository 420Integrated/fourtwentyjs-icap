...
Utilities for handling [ICAP](https://github.com/420integrated/go-420coin/wiki/wiki/ICAP:-Inter-exchange-Client-Address-Protocol) addresses.
...
The `nonstd` parameter of `fromAddress`, when set to true, will turn on support for the *basic ICAP format* generating an invalid IBAN, but encoding the entire 160 bits of an 420coin address.
...
Alternatively [`fourtwentyjs-wallet`](http://npmjs.com/packages/fourtwentyjs-wallet) can be used to generate compatible addresses.
