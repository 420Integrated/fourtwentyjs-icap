...
ICAP.decodeBBAN = function (bban) {
  ...
  if (length === 30 || length === 31) {
    ...
    throw new Error('Not a valid 420coin BBAN')
  }
}
...
ICAP.encodeBBAN = function (bban) {
  if (typeof bban === 'object') {
    if (bban.asset.length !== 3 ||
      ...
      throw new Error('Invalid \'indirect\' 420coin BBAN')
    }
    ...
    throw new Error('Not a valid input for 420coin BBAN')
  }
}
...
/*
 * Convert 420coin address to ICAP
 * @method fromAddress
